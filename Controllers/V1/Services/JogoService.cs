...
using Diojogos.Controllers.V1.Exceptions;
using Diojogos.Controllers.V1.InputModel;
using Diojogos.Controllers.V1.Repositories;
using Diojogos.Controllers.V1.ViewModel;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace DioJogos.Controllers.V1.Services
{
